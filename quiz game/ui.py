...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.feedback = Label(self.window, pady=10, font=("times new roman", 15, "bold"))
    ...
    def display_title(self):
        """To display title"""
        title = Label(self.window, text="iQuiz Application", width=50, bg="blue", fg="white", font=("times new roman", 20, "bold"))
        # place of title
        title.place(x=0, y=2)
